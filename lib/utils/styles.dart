...
class Styles{
  ...
  static Color textColor2 = Colors.grey.shade300;
  static Color searchbar = Color.fromARGB(0, 26, 8, 98);
  ...
  static TextStyle cardTextStyle = TextStyle(fontSize: 12, color: Colors.grey.shade500, fontWeight: FontWeight.w400);
